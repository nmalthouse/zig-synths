...
pub fn build(b: *std.Build) void {
    ...
    const sine_gen = b.addExecutable(.{
        .name = "sinegen",
        .link_libc = true,
        .root_source_file = b.path("src/sine_gen.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    exe.linkSystemLibrary2("jack", .{});
    exe.linkSystemLibrary2("fftw3f", .{});

    sine_gen.root_module.addImport("graph", ratmod);
    sine_gen.addSystemIncludePath(.{ .cwd_relative = "/usr/lib" });
